  ...
  void calculateLateAndOvertime() {
    if (!isWeekend(widget.selectedDate) && !isHoliday()) {
      if (widget.attendanceRecords.isNotEmpty) {
        ...
        num totalWorkHours = dailyWorkingTimeData?['totalworkingtime'] ?? 0;
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: widget.isSelected
                            ? const Color.fromARGB(255, 188, 0, 221)
                                .withOpacity(0.3)
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: widget.isSelected
                            ? [
                                Color.fromARGB(255, 234, 16, 190)
                                    .withOpacity(0.5),
                                Color.fromARGB(255, 255, 34, 100)
                                    .withOpacity(0.7)
                              ]
                            : [
                                Colors.lightBlue.withOpacity(0.0),
