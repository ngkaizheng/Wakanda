...
class _AttendanceViewState extends State<AttendanceView> {
  ...
  Future<Map<String, Map<String, dynamic>>> getUsersWithAttendance(
    ...
    for (var doc in attendanceSnapshot.docs) {
      QuerySnapshot dateSnapshot = await doc.reference
            ...
            ElevatedButton(
              ...
              style: ButtonStyle(
                backgroundColor:
                  ...
                  return Color.fromRGBO(240, 106, 255, 1);
                ...
                shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                  RoundedRectangleBorder(
                    ...
                    side: BorderSide(
                        color: Color.fromRGBO(229, 63, 248, 1), width: 2),
                  ),
                ),
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    DateFormat.yMd()
                        .format(_selectedDate), // Format to display date only
                          ...
                          return GestureDetector(
                            ...
                            child: Card(
                              ...
                              child: ListTile(
                                ...
                                leading: Hero(
                                  tag:
                                      'avatar_${userDetails['name']}', // Unique hero tag
                                  child: CircleAvatar(
                                    backgroundImage:
